...
2. when we click the user id, it should create a new table that shows the posts of that user
3. when we click the post id, it should create a new table that shows comments of that post
